...
class CardAdapterHistory(
    val item : ArrayList<TaskResponse.Data>
): RecyclerView.Adapter<CardAdapterHistory.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardAdapterHistory.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: CardAdapterHistory.ViewHolder, position: Int) {
        ...
        if (task_list.task_status_int!! > 1){
